...
class buskar extends StatelessWidget {
  @override
                          ...
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: FittedBox(
                                  fit: BoxFit.fitWidth,
                                  child:
                                  Image.asset('images/Instagram_logo_black.png')),
                            ),
                          ),
                          Flexible(
                            fit: FlexFit.tight,
                              ...
                              Expanded(
                                  ...
                                  child: Container(
                                      ...
                                      padding: EdgeInsets.fromLTRB(
                                          25.0, 12.0, 0.0, 9.0),
                                      child: Image.asset(
                                        'images/noun_Search_2475045.png',
                                        fit: BoxFit.contain,
                                      ))),
                              Expanded(
                                  flex: 10,
                              ...
                              Expanded(
                                  ...
                                  child: Container(
                                      padding: EdgeInsets.fromLTRB(
                                          0.0, 10.0, 40.0, 9.0),
                                      child: Image.asset(
                                        'images/noun_qr_2499774_pink.png',
                                        fit: BoxFit.contain,
                                      ))),
                            ],
                          ),
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: FittedBox(
                                    fit: BoxFit.fitWidth,
                                    child: Image.asset(
                                        'images/noun_Home_1315561_grey.png')),
                              ),
                            ),
                            Expanded(
                              flex: 1,
